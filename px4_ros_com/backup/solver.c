...
void setup_pointers(void) {
  ...
  vars.u_12 = work.x + 96;
  vars.u_13 = work.x + 99;
  vars.u_14 = work.x + 102;
  vars.u_15 = work.x + 105;
  vars.u_16 = work.x + 108;
  vars.u_17 = work.x + 111;
  vars.u_18 = work.x + 114;
  vars.u_19 = work.x + 117;
  vars.u_20 = work.x + 120;
  vars.x_1 = work.x + 123;
  vars.x_2 = work.x + 131;
  vars.x_3 = work.x + 139;
  vars.x_4 = work.x + 147;
  ...
  vars.x_8 = work.x + 179;
  vars.x_9 = work.x + 187;
  vars.x_10 = work.x + 195;
  vars.x_11 = work.x + 203;
  vars.x_12 = work.x + 211;
  vars.x_13 = work.x + 219;
  vars.x_14 = work.x + 227;
  vars.x_15 = work.x + 235;
  vars.x_16 = work.x + 243;
  vars.x_17 = work.x + 251;
  vars.x_18 = work.x + 259;
  vars.x_19 = work.x + 267;
  vars.x_20 = work.x + 275;
  vars.x_21 = work.x + 283;
}
void setup_indexed_params(void) {
  ...
  params.u_ss[19] = params.u_ss_19;
  params.x_ss[20] = params.x_ss_20;
  params.u_ss[20] = params.u_ss_20;
...
double eval_objv(void) {
  ...
  objv += work.quad_345851330560[0]+work.quad_503357964288[0]+work.quad_689417555968[0]+work.quad_590025695232[0]+work.quad_24887435264[0]+work.quad_373406756864[0]+work.quad_282534416384[0]+work.quad_569492807680[0]+work.quad_658085392384[0]+work.quad_268442972160[0]+work.quad_212760903680[0]+work.quad_604237524992[0]+work.quad_899615596544[0]+work.quad_9807298560[0]+work.quad_730290806784[0]+work.quad_691068739584[0]+work.quad_512929845248[0]+work.quad_46428270592[0]+work.quad_907958816768[0]+work.quad_364190564352[0]+work.quad_603410014208[0]+work.quad_253294055424[0]+work.quad_406480764928[0]+work.quad_450189660160[0]+work.quad_622448181248[0]+work.quad_135073144832[0]+work.quad_512757641216[0]+work.quad_265658822656[0]+work.quad_225439469568[0]+work.quad_611752235008[0]+work.quad_945124098048[0]+work.quad_625116979200[0]+work.quad_566313590784[0]+work.quad_323441446912[0]+work.quad_589385719808[0]+work.quad_920610275328[0]+work.quad_700597231616[0]+work.quad_379984363520[0]+work.quad_438523551744[0]+work.quad_43660177408[0]+work.quad_837056782336[0]+work.quad_396244647936[0]+work.quad_326908334080[0]+work.quad_28181692416[0];
  return objv;
}
...
void fillrhs_cc(void) {
  ...
  double minval;
  r2 = work.rhs + 291;
  ds_aff = work.lhs_aff + 291;
  dz_aff = work.lhs_aff + 417;
  mu = 0;
  for (i = 0; i < 126; i++)
...
long solve(void) {
...
#ifndef ZERO_LIBRARY_MODE
  if (settings.verbose)
    printf("iter     objv        gap       |Ax-b|    |Gx+s-h|    step    x[i][0]  x[i][1]  x[i][2]  u[i][0]   u[i][1]   u[i][2]\n");
#endif
  fillq();
  fillh();
  fillb();
  ...
  for (iter = 0; iter < settings.max_iters; iter++) {
    ...
    if (settings.verbose) {
      ...
      if(iter > 0 && iter < 20)
      printf("%3d   %10.3e  %9.2e  %9.2e  %9.2e  % 6.4f  % 6.4f  % 6.4f  % 6.4f  % 6.4f  % 6.4f  % 6.4f\n",
          iter+1, work.optval, work.gap, sqrt(work.eq_resid_squared),
          sqrt(work.ineq_resid_squared), alpha, vars.x[iter][0], vars.x[iter][1], vars.x[iter][2], vars.u[iter][0], vars.u[iter][1], vars.u[iter][2]);
      else 
